                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        ...
                        <h2 class="pageheader-title">
                            <p class="float-right"  style="margin-right: 1%"> <a href="{{ route('category.create') }}" class="btn btn-outline-primary" style="margin: 5px">
                                <i class="fas fa-plus" aria-hidden="true"></i> Add Category</a></p> 
                            All Categories Are Here.   
                        </h2>
                       
                            <br>
                        <p style="color: gray; font-style:inherit; margin-right: 2%; margin-top:10px" class="float-right" >Total Categories - {{ \App\Models\Category::count() }}</p> 
                        <p class="pageheader-text">Check Out the Categories</p>
                              ...
                              @endif 
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('category.edit',$item->id) }}" class="btn btn-outline-primary" style="margin: 5px">
                                                <i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
                                            <a href="{{ route('category.destroy',$item->id) }}" type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#myModal{{ $item->id }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    Are You Sure ?  
                     <br>If you delete the data, you will not be able to recover the data & if you delete Parent Category then its Child Category will become Parent Category
                </div>
                <!-- Modal footer -->
