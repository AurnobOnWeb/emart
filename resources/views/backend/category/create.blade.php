...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Category Add Form </h5>
                    <div class="card-body">
                        <form id="validationform" method="post" action="{{ route('category.store') }}"  enctype="multipart/form-data" data-parsley-validate="" novalidate="">
                            {{ csrf_field() }}
                            @method('post')
                            ...
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Category Image</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" value="1" checked id="is_parent" name="is_parent"  class="custom-control-input"><span class="custom-control-label">Yes</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row d-none" id="parent_cat_div">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <select id="parent_category" class="selectpicker"  name="parent_id">
                                        ...
                                        <option value="{{ $items->id }}" {{ old('parent_id')==$items->id  ? 'checked' :'' }}>{{ $items->title }}</option>
                                      @endforeach
                                    </select>
                                </div>
                            </div>
